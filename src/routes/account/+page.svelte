    ...
    <div class="pt-4 lg:pt-8">
      <div class="mx-auto max-w-4xl px-4 sm:px-4 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8">
        ...
        <div class="mt-4 lg:row-span-1 lg:mt-0">
          ...
          <p class="text-3xl tracking-tight text-gray-300 mb-4">Account { $sessionAddress === data.account.address ? "(you)" : "" }</p>
          ...
          <div class="mt-8">
            ...
            <p class="text-gray-300 truncate"><!--{data.account.listings.length}-->Coming soon tm</p>
